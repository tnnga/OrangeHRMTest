...
public class ExtentTestManager extends BaseSetupForXML {
    ...
    public static WebDriver getDriver() {
        WebDriver driver = BaseSetupForXML.getDriver();
        return driver;
    }

    public static void addScreenShot(String message) {
        String base64Image = "data:image/png;base64,"
                + ((TakesScreenshot) BaseSetupForXML.getDriver()).getScreenshotAs(OutputType.BASE64);
